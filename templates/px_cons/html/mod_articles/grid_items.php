...
<div class="articles-slide-wrapper-<?php echo $module->id; ?>">
  <div class="articles-slide articles owl-carousel owl-theme">
          ...
          <article class="article-item" itemscope itemtype="https://schema.org/Article">
            ...
            <div class="item-content">
              <?php if ($params->get('item_title')) : ?>
                ...
                <<?php echo $item_heading; ?> class="item-title" itemprop="name">
              ...
              <?php if ($displayInfo) : ?>
                ...
                <ul class="item-meta">
                  ...
                  <?php if ($item->displayAuthorName) : ?>
                    <li class="item-author <?php echo ($params->get('info_layout') == 1 ? 'list-inline-item' : ''); ?>">
                      <?php echo htmlspecialchars($item->displayAuthorName, ENT_QUOTES, 'UTF-8'); ?>
                    </li>
                  <?php endif; ?>

                  <?php if ($item->displayCategoryTitle) : ?>
                    <li class="item-category <?php echo ($params->get('info_layout') == 1 ? 'list-inline-item' : ''); ?>">
                  ...
                  <?php if ($item->displayDate) : ?>
                    <li class="item-date <?php echo ($params->get('info_layout') == 1 ? 'list-inline-item' : ''); ?>">
                      <?php echo htmlspecialchars($item->displayDate, ENT_QUOTES, 'UTF-8'); ?>
                    </li>
                  <?php endif; ?>

                  <?php if ($item->displayHits) : ?>
                    <li class="item-hits <?php echo ($params->get('info_layout') == 1 ? 'list-inline-item' : ''); ?>">
