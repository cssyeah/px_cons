...
<div class="wt-flex-layout team team-<?php echo $module->id; ?> layout-04 <?php echo $modSpacingTop . ' ' . $modSpacingBottom; ?>" style="<?php echo $modStyle; ?>">
    ...
    <div class="team-item">      
      <div class="team-item-inner" style="background-color: <?php echo $memberBgColor; ?>; border: <?php echo $memberBorderWidth; ?>px solid <?php echo $memberBorderColor; ?>; border-radius: <?php echo $memberBorderRadius; ?>px; color: <?php echo $memberTextColor; ?>; text-align: <?php echo $memberTextAlignment; ?>; padding: <?php echo $memberPadding; ?>px;">
        ...
        <?php if($item->member_image) : ?>
          <div class="member-image" style="border-radius: <?php echo $mediaBorderRadius; ?>px;"><img src="<?php echo $item->member_image; ?>" alt="" /></div>
        <?php endif; ?>
        ...
        <div class="member-info-wrapper">
          <div class="member-name-wrapper">
            ...
            <?php if($item->member_website_name) : ?>
              <a href="<?php echo $item->member_website_url; ?>" title="<?php echo $item->member_website_name; ?>" target="_blank"><i class="fa-solid fa-arrow-up-right-from-square"></i></a>              
            <?php endif; ?>            
          </div>
