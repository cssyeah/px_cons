...
<div class="wt-flex-layout clients clients-<?php echo $module->id; ?> layout-03 <?php echo $modSpacingTop . ' ' . $modSpacingBottom; ?>" style="<?php echo $modStyle; ?>">
    ...
    <div class="col-12 col-lg-6">
      <div class="clients-list">
        ...
        <?php foreach ($items as $item) { ?>
          ...
          <li style="background-color: <?php echo $clientBgColor; ?>; border: <?php echo $clientBorderWidth; ?>px solid <?php echo $clientBorderColor; ?>; border-radius: <?php echo $clientBorderRadius; ?>px; padding: <?php echo $clientPadding; ?>px;">
            ...
            <?php if($item->client_link_url) : ?>
              <a href="<?php echo $item->client_link_url; ?>" title="<?php echo $item->client_name; ?>" class="link-mask" target="_blank"></a>
            <?php endif ?>
