...
<div class="wt-flex-layout social-links social-links-<?php echo $module->id; ?> layout-03<?php echo ' social-icon-size-'.$socialIconSize; ?><?php echo ' social-icon-style-'.$socialIconStyle; ?> ">
