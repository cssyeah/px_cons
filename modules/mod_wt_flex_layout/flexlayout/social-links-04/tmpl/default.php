...
$itemPerRow = $styleconfig->get('social_item_per_row', 2);
...
<div class="wt-flex-layout social-links social-links-<?php echo $module->id; ?> layout-04<?php echo ' social-icon-size-'.$socialIconSize; ?><?php echo ' social-icon-style-'.$socialIconStyle; ?> ">
  <?php if(trim($customText)) : ?>
  <p><?php echo $customText; ?></p>
  <?php endif ?>

  <ul style="grid-template-columns: repeat(<?php echo $itemPerRow; ?>,1fr);">
