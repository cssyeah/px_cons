...
<div class="wt-flex-layout features features-<?php echo $module->id; ?> layout-07 <?php echo $modSpacingTop . ' ' . $modSpacingBottom; ?>" style="<?php echo $modStyle; ?>">
  ...
  <div class="row">
    <div class="col-12 col-md-7">
      ...
      <div class="features-wrapper" style="grid-template-columns: repeat(<?php echo $itemPerRow; ?>, auto); column-gap: <?php echo $featureItemGap; ?>">
          ...
          <div class="feature-item-inner">
            ...
            <div class="feature-ct">
              <?php if ($item->feature_title) : ?>
                <h6 class="feature-title"><?php echo $item->feature_title; ?></h6>
              <?php endif; ?>
            </div>
