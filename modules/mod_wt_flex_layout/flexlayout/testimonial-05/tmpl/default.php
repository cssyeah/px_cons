...
<div class="wt-flex-layout testimonials testimonial-<?php echo $module->id; ?> layout-05 <?php echo $modSpacingTop . ' ' . $modSpacingBottom; ?>" style="<?php echo $modStyle; ?>">
    ...
    <div class="col-12 col-lg-5">
      ...
      <?php if ($modBtnLabel) : ?>
        <div class="mod-action">
          <a href="<?php echo $modBtnUrl; ?>" title="" class="btn btn-lg <?php echo $modBtnType; ?>"><?php echo $modBtnLabel; ?></a>
        </div>
      <?php endif; ?>
    </div>
          ...
          <div class="testimonial-item">
            <div class="testimonial-item-inner">
              ...
              <?php if ($item->customer_testimonial) : ?>
                <span class="customer-testimonial-icon"><i class="fa-solid fa-quote-left"></i></span>
  ...
  (function($) {
    jQuery(document).ready(function($) {
      ...
      owlTestimonial<?php echo $module->id; ?>.owlCarousel({
        ...
        mouseDrag: true,
        navText: [
          '<i class="fa-solid fa-arrow-left"></i>', // HTML for the previous button
