...
<div class="wt-flex-layout features features-<?php echo $module->id; ?> layout-03 <?php echo $modSpacingTop . ' ' . $modSpacingBottom; ?>" style="<?php echo $modStyle; ?>">
    ...
    <div class="feature-item">
      <div class="feature-item-inner<?php echo $featureTextAlignment?' text-'.$featureTextAlignment.'':''; ?>" style="<?php echo $featureStyle; ?>">
        ...
        <?php if($item->feature_image) : ?>
          <span class="feature-media" style="margin: -<?php echo $featurePadding ?>; margin-top: auto;">
            <img src="<?php echo $item->feature_image; ?>" alt="" />
          </span>
        <?php endif; ?>

        <?php if($item->feature_link_url) : ?>
          <a href="<?php echo $item->feature_link_url; ?>" class="link-mask" title="<?php echo $item->feature_title; ?>"></a>
        <?php endif ?>
      </div>
    </div>
  <?php } ?>
