...
$featureStyle = '';
$featureStyle .= $statsTextAlignment?'text-align: '.$statsTextAlignment.';':'';
...
<div class="wt-flex-layout stats stats-<?php echo $module->id; ?> layout-01 <?php echo $modSpacingTop . ' ' . $modSpacingBottom; ?>" style="<?php echo $modStyle; ?>">
  ...
  <?php foreach ($items as $item) { ?>
    <div class="stats-item">
      <div class="stats-item-inner<?php echo $statsTextAlignment?' text-'.$statsTextAlignment.'':''; ?>">
